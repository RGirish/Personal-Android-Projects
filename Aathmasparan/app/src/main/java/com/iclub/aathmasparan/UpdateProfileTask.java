...
public class UpdateProfileTask extends AsyncTask<String, Void, String>
{
    ...
    private String msg;
    public UpdateProfileTask(FetchDataListener listener)
    {
    ...
    protected String doInBackground(String... params){
        try{
            URL url = new URL("http://aathmasparan.in/update_app.php?"+params[0]);
            Log.e("URL","http://aathmasparan.in/update_app.php?"+params[0]);
    ...
    protected void onPostExecute(String s){
    	...
    	if(s.contains("done")){
            listener.onFetchComplete("update");
        }else{
