...
public class MainActivity extends ListActivity 
{
	Context context;
	ProgressDialog pd;
	List<Message> messages=new ArrayList<Message>(25);
	List<Message> msgfrmwu=new ArrayList<Message>(25);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) 
	{
		...
		String likepage="http://www.facebook.com/MedPlex";
		URL u;
		try {
			u = new URL(likepage);
	...
	{
		final Weather[] weather_dat = new Weather[19+8+6];
