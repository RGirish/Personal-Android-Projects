...
public class AllThreads {
	...
	public void toaster(int n, BluetoothDevice mmDevice) {
		...
		case 1:
			...
			Message msg = mHandler.obtainMessage(GameScreen.MESSAGE_TOAST);
			Bundle bundle = new Bundle();
			bundle.putString(GameScreen.TOAST, mes);
			msg.setData(bundle);
		...
		case 2:
			...
			Message msg1 = mHandler.obtainMessage(GameScreen.MESSAGE_TOAST);
			Bundle bundle1 = new Bundle();
			bundle1.putString(GameScreen.TOAST, mes1);
		...
		public void run() {
			...
			while (true) {
				try {
					...
					mHandler.obtainMessage(GameScreen.MESSAGE_READ, bytes, -1,
							buffer).sendToTarget();
