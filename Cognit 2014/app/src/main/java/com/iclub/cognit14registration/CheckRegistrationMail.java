...
public class CheckRegistrationMail extends Activity implements FetchDataListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.checkregistrationmail);
	...
	public void onclicksearch(View v)
	{
		...
		if(checkConnection())
		{
			...
			task1.execute("http://quillonparchment.in/cognit14/returndetailsmail.php?mail="+mail);
		}
		else
		{
